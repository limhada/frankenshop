...
export default async function handler(
  ...
  if (req.method === 'GET') {
    ...
    // console.log(session.user.emacartListil, "확인~~~~~~~~~~~~~~")
    try {
      ...
      // const contentIds = cartList.map(cartItem => cartItem.contents);
      // console.log('cartPament - contentIds ~~~~~~', contentIds);
      ...
      // const insert = await db.collection('cartOrders').insertOne(insertData);
